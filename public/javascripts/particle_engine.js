...
{
  var particleMaterialAttributes = {
    customVisible: [],
    customColor: [],
    customOpacity: [],
    customSize: [],
    ...
    particleMaterialAttributes.customVisible.push(1); 
		particleMaterialAttributes.customColor.push(this.particleArray[i].color.r, this.particleArray[i].color.g, this.particleArray[i].color.b);   
		particleMaterialAttributes.customOpacity.push(this.particleArray[i].opacity);
		particleMaterialAttributes.customSize.push(this.particleArray[i].size);    
		particleMaterialAttributes.customAngle.push(this.particleArray[i].angle);
  }
  

  this.particleMaterial.addAttribute( 'customVisible', new THREE.Float32BufferAttribute( particleMaterialAttributes.customVisible, 1 ).setDynamic( true ) );
  this.particleMaterial.addAttribute( 'customColor', new THREE.Float32BufferAttribute( particleMaterialAttributes.customColor, 3  ).setDynamic( true ) );
  this.particleMaterial.addAttribute( 'customOpacity', new THREE.Float32BufferAttribute( particleMaterialAttributes.customOpacity, 1 ).setDynamic( true ) );
  this.particleMaterial.addAttribute( 'customSize', new THREE.Float32BufferAttribute( particleMaterialAttributes.customSize, 1 ).setDynamic( true ) );
  this.particleMaterial.addAttribute( 'customAngle', new THREE.Float32BufferAttribute( particleMaterialAttributes.customAngle, 1 ).setDynamic( true ) );
...
ParticleEngine.prototype.update = function(dt)
{
  ...
  var customVisible = this.particleMaterial.attributes.customVisible.array
  var customColor = this.particleMaterial.attributes.customColor.array
  var customOpacity = this.particleMaterial.attributes.customOpacity.array
  var customSize = this.particleMaterial.attributes.customSize.array
  var customAngle = this.particleMaterial.attributes.customAngle.array
	...
	for (var i = 0; i < this.particleCount; i++)
	{
      ...
      customVisible = this.particleArray[i].alive;
			customColor   = this.particleArray[i].color;
			customOpacity = this.particleArray[i].opacity;
			customSize    = this.particleArray[i].size;
			customAngle   = this.particleArray[i].angle;
		}		
  }

  this.particleMaterial.attributes.customVisible.needsUpdate = true
  this.particleMaterial.attributes.customColor.needsUpdate = true
  this.particleMaterial.attributes.customOpacity.needsUpdate = true
  this.particleMaterial.attributes.customSize.needsUpdate = true
...
/* 
	...
	particleTexture : new THREE.TextureLoader().load( '../images/particle/star.png' ),
...
Systems =
{
	...
	fireball :
	{
		...
		particleTexture : new THREE.TextureLoader().load( '../images/particle/smokeparticle.png' ),
	...
	fireflies :
	{
		...
		particleTexture : new THREE.TextureLoader().load( '../images/particle/spark.png' ),
